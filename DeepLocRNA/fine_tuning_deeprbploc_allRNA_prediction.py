        ...
        if plot == "True":
            ...
            for idx, pred in enumerate(y_pred):
                ...
                for t in batch_str[idx].split("/"):
                    ...
                    fig1.savefig("./motif_line_plot_%s_%s.png" % (items, t), dpi=300)
                    if att_config is not None:
                        ...
                        fig1 = plot_motif(att[s:e+1], figsize=(16, 6), start = s)#to show complete x-axis
                        fig1.savefig("./motif_log_%s_%s.png" % (items, t), dpi=300)
