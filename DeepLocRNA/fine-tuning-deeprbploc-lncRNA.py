...
class lncTune:
        ...
        if not self.load_data:
            ...
            if self.RNA_tag:
                for i in range(5):
                    ...
                    np.save("/home/sxr280/DeepRBPLoc/new_data/lncRNA/" + dataset_name + "/Train_fold%s_X_tag.npy" % str(i), Xtrain[i])
                    np.save("/home/sxr280/DeepRBPLoc/new_data/lncRNA/" + dataset_name + "/Test_fold%s_X_tag.npy" % str(i), Xtest[i])
                    np.save("/home/sxr280/DeepRBPLoc/new_data/lncRNA/" + dataset_name + "/Val_fold%s_X_tag.npy" % str(i), Xval[i])

                    np.save("/home/sxr280/DeepRBPLoc/new_data/lncRNA/" + dataset_name + "/Train_fold%s_y.npy" % str(i), Ytrain[i])
                    np.save("/home/sxr280/DeepRBPLoc/new_data/lncRNA/" + dataset_name + "/Test_fold%s_y.npy" % str(i), Ytest[i])
                    np.save("/home/sxr280/DeepRBPLoc/new_data/lncRNA/" + dataset_name + "/Val_fold%s_y.npy" % str(i), Yval[i])

                    np.save("/home/sxr280/DeepRBPLoc/new_data/lncRNA/" + dataset_name + "/Train_fold%s_mask.npy" % str(i), Train_mask_label[i])
                    np.save("/home/sxr280/DeepRBPLoc/new_data/lncRNA/" + dataset_name + "/Test_fold%s_mask.npy" % str(i), Test_mask_label[i])
                    np.save("/home/sxr280/DeepRBPLoc/new_data/lncRNA/" + dataset_name + "/Val_fold%s_mask.npy" % str(i), Val_mask_label[i])
                exit()

            else:
                for i in range(5):

                    np.save("/home/sxr280/DeepRBPLoc/new_data/lncRNA/" + dataset_name + "/Train_fold%s_X.npy" % str(i), Xtrain[i])
                    np.save("/home/sxr280/DeepRBPLoc/new_data/lncRNA/" + dataset_name + "/Test_fold%s_X.npy" % str(i), Xtest[i])
                    np.save("/home/sxr280/DeepRBPLoc/new_data/lncRNA/" + dataset_name + "/Val_fold%s_X.npy" % str(i), Xval[i])
            ...
            # X_train_tag = np.load("/home/sxr280/DeepRBPLoc/new_data/lncRNA/" + dataset_name + "/Train_fold%s_X_tag.npy" % str(self.fold))
            X_train = np.load("/home/sxr280/DeepRBPLoc/new_data/lncRNA/" + dataset_name + "/Train_fold%s_X.npy" % str(self.fold))
            Y_train = np.load("/home/sxr280/DeepRBPLoc/new_data/lncRNA/" + dataset_name + "/Train_fold%s_y.npy" % str(self.fold))
            Train_mask = np.load("/home/sxr280/DeepRBPLoc/new_data/lncRNA/" + dataset_name + "/Train_fold%s_mask.npy" % str(self.fold))

            # X_val_tag = np.load("/home/sxr280/DeepRBPLoc/new_data/lncRNA/" + dataset_name + "/Val_fold%s_X_tag.npy" % str(self.fold))
            X_val = np.load("/home/sxr280/DeepRBPLoc/new_data/lncRNA/" + dataset_name + "/Val_fold%s_X.npy" % str(self.fold))
            Y_val = np.load("/home/sxr280/DeepRBPLoc/new_data/lncRNA/" + dataset_name + "/Val_fold%s_y.npy" % str(self.fold))
            Val_mask = np.load("/home/sxr280/DeepRBPLoc/new_data/lncRNA/" + dataset_name + "/Val_fold%s_mask.npy" % str(self.fold))

            # X_test_tag = np.load("/home/sxr280/DeepRBPLoc/new_data/lncRNA/" + dataset_name + "/Test_fold%s_X_tag.npy" % str(self.fold))
            X_test = np.load("/home/sxr280/DeepRBPLoc/new_data/lncRNA/" + dataset_name + "/Test_fold%s_X.npy" % str(self.fold))
            Y_test = np.load("/home/sxr280/DeepRBPLoc/new_data/lncRNA/" + dataset_name + "/Test_fold%s_y.npy" % str(self.fold))
            Test_mask = np.load("/home/sxr280/DeepRBPLoc/new_data/lncRNA/" + dataset_name + "/Test_fold%s_mask.npy" % str(self.fold))
    ...
    def train_model(self, mRNA_ck_path = "/home/sxr280/DeepRBPLoc/Results/sequantial_fold0/checkpoints_33/epoch=73-step=25604.ckpt",
        ...
        dataset_name = dataset.split("/")[-1].split(".")[0]
        string = "".join(pickle.load(open("/home/sxr280/DeepRBPLoc/new_data/lncRNA/%s/Test5%s.pkl" % (dataset_name, self.fold), "rb")))
        ...
        try:
            ...
            print("before loading the best:", model.state_dict()["network.fc1.weight"])
            model.load_state_dict(model_state)
            print("saved checkpoint:", checkpoint['state_dict']["network.fc1.weight"])
            print("after loading the best:", model.state_dict()["network.fc1.weight"])
            print("the model network state dict:", model.network.state_dict()["fc1.weight"])
            ...
            val.evaluation(light_model = model, left=self.left, right=self.right, RNA_type = RNA_type, testloader = dataloader_test, RNA_index = RNA_index)
        except:
            print("pass this task!!!")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--lr', type=float, default=0.0005, help='The learning rate to train the model')
    ...
    for i in range(5):
        tune = lncTune(left = 4000, right = 4000, device = "cuda", num_task = 9, fold = i, DDP = args.DDP, load_data = args.load_data, 
        ...
        tune.train_model(dataset = dataset, batch_size = args.batch_size, RNA_type = "lncRNA", release_layer = args.layer)
